...
import (
	...
	"github.com/DataTunerX/data-plugins/internal/controller"
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "dataplugin-controller-lock",
	...
	if err = (&controller.DataPluginReconciler{
		Client: mgr.GetClient(),
		Scheme: mgr.GetScheme(),
		Log:    logger,
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "unable to create controller", "controller", "DataPlugin")
		os.Exit(1)
	}
